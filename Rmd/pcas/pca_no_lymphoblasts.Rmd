...
### PCA of GEO data, excluding outliers and lymphoblasts
...
load("scores.no.lymphoblasts.Rdata")

#   scores = p.no.lymphoblasts %>%
#     scores %>%
#     as.data.frame %>%
